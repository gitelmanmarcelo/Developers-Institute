...
const sum = data.reduce( (accum,el) => accum + el.age*7, 0)

// Exercise 2 : Email
// Instructions
// Clean up this email to have no whitespaces. Do it in a single line (return a new string).
const userEmail3 = ' cannotfillemailformcorrectly@gmail.com '
const userEmail4 = ' cannotfillemailformcorrectly@gmail.com '.trim();
...
// Change the structure of the users array. The user’s full name should be the key
//  and the user’s role should be the value.
...
users.forEach( (el,i) => {
    users2[el.firstName+' '+el.lastName] = el.role;
    users.splice(i,1,users2);
});
...
const obj2 = letters.reduce( (accum,el) => {
    accum[el] = accum[el]+1 || 1;
    return accum;
},{})